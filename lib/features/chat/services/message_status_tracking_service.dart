...
class MessageStatusTrackingService {
  ...
  Future<void> updateTypingIndicator(String conversationId, String userId, bool isTyping) async {
    try {
      print('📊 MessageStatusTrackingService: Updating typing indicator: $userId -> $isTyping');
      ...
      print('📊 MessageStatusTrackingService: ✅ Typing indicator updated: $userId -> $isTyping');
    } catch (e) {
      print('📊 MessageStatusTrackingService: ❌ Failed to update typing indicator: $e');
    }
  }
