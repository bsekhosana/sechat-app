...
// in sechat_app/test/features/chat/providers/session_chat_provider_test.dart.
...
import 'package:sechat_app/core/services/se_session_service.dart' as _i6;
import 'package:sechat_app/core/services/se_socket_service.dart' as _i3;
import 'package:sechat_app/core/services/unified_message_service.dart' as _i2;
import 'package:sechat_app/features/chat/models/chat_conversation.dart' as _i8;
import 'package:sechat_app/features/chat/models/message.dart' as _i9;
...
class _FakeMessageSendResult_0 extends _i1.SmartFake
    implements _i2.MessageSendResult {
  _FakeMessageSendResult_0(
    Object parent,
...
class MockSeSocketService extends _i1.Mock implements _i3.SeSocketService {
  MockSeSocketService() {
  ...
  @override
  _i4.Stream<bool> get connectionStateStream => (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> connect(String? sessionId) => (super.noSuchMethod(
        Invocation.method(
          #connect,
          [sessionId],
        ),
  ...
  @override
  _i4.Future<void> manualConnect() => (super.noSuchMethod(
        Invocation.method(
          #manualConnect,
          [],
        ),
  ...
  @override
  _i4.Future<void> emergencyReconnect() => (super.noSuchMethod(
        Invocation.method(
          #emergencyReconnect,
          [],
        ),
  ...
  @override
  _i4.Future<void> deleteSessionOnServer({String? sessionId}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> sendMessageStatusUpdate({
    required String? recipientId,
    required String? messageId,
    String? status,
  }) =>
  ...
  @override
  _i4.Future<Map<String, dynamic>> checkQueueStatus() => (super.noSuchMethod(
        Invocation.method(
          #checkQueueStatus,
          [],
        ),
  ...
  @override
  _i4.Future<void> forceDisconnect() => (super.noSuchMethod(
        Invocation.method(
          #forceDisconnect,
          [],
        ),
  ...
  @override
  _i4.Future<Map<String, dynamic>> checkConnectionQuality() =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> sendUserOnlineStatus(bool? isOnline) => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<bool> testSocketConnection() => (super.noSuchMethod(
        Invocation.method(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSeSessionService extends _i1.Mock implements _i6.SeSessionService {
  MockSeSessionService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<bool> hasPersistentSession() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> reloadSessionFromStorage() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> backupSession() => (super.noSuchMethod(
        Invocation.method(
          #backupSession,
          [],
        ),
  ...
  @override
  _i4.Future<bool> restoreSessionFromBackup() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<String> decryptPrivateKey(String? encryptedPrivateKey) =>
      (super.noSuchMethod(
        Invocation.method(
          #decryptPrivateKey,
          [encryptedPrivateKey],
  ...
  @override
  _i4.Future<Map<String, dynamic>> createSession(String? displayName) =>
      (super.noSuchMethod(
        Invocation.method(
          #createSession,
          [displayName],
  ...
  @override
  _i4.Future<_i6.SessionData?> loadSession() => (super.noSuchMethod(
        Invocation.method(
          #loadSession,
          [],
        ),
        returnValue: _i4.Future<_i6.SessionData?>.value(),
      ) as _i4.Future<_i6.SessionData?>);
  ...
  @override
  _i4.Future<bool> userExists(String? displayName) => (super.noSuchMethod(
        Invocation.method(
          #userExists,
          [displayName],
        ),
  ...
  @override
  _i4.Future<bool> isSessionIdUnique(String? sessionId) => (super.noSuchMethod(
        Invocation.method(
          #isSessionIdUnique,
          [sessionId],
        ),
  ...
  @override
  _i4.Future<bool> isSessionLoggedIn() => (super.noSuchMethod(
        Invocation.method(
          #isSessionLoggedIn,
          [],
        ),
  ...
  @override
  _i4.Future<Map<String, dynamic>> validateSessionPersistence() =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> deleteAllChats() => (super.noSuchMethod(
        Invocation.method(
          #deleteAllChats,
          [],
        ),
  ...
  @override
  _i4.Future<void> storeEncryptedMessage(
    String? sessionId,
    _i6.EncryptedMessage? message,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<List<_i6.EncryptedMessage>> getEncryptedMessages(
          String? sessionId) =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue: _i4.Future<List<_i6.EncryptedMessage>>.value(
            <_i6.EncryptedMessage>[]),
      ) as _i4.Future<List<_i6.EncryptedMessage>>);

  @override
  _i4.Future<void> clearSessionMessages(String? sessionId) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<bool> verifySessionIntegrity() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<String> exportSessionData() => (super.noSuchMethod(
        Invocation.method(
          #exportSessionData,
          [],
        ),
  ...
  @override
  _i4.Future<void> importSessionData(String? exportedData) =>
      (super.noSuchMethod(
        Invocation.method(
          #importSessionData,
          [exportedData],
  ...
  @override
  _i4.Future<void> initializeNotificationServices() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> registerDeviceToken(String? deviceToken) =>
      (super.noSuchMethod(
        Invocation.method(
          #registerDeviceToken,
          [deviceToken],
  ...
  @override
  _i4.Future<void> unregisterDeviceToken() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<bool> areNotificationServicesConfigured() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> regenerateProperKeys() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<String?> getDecryptedPrivateKey() => (super.noSuchMethod(
        Invocation.method(
...
class MockMessageStorageService extends _i1.Mock
    implements _i7.MessageStorageService {
  ...
  @override
  _i4.Future<void> saveConversation(_i8.ChatConversation? conversation) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveConversation,
          [conversation],
  ...
  @override
  _i4.Future<void> saveMessage(_i9.Message? message) => (super.noSuchMethod(
        Invocation.method(
          #saveMessage,
          [message],
        ),
  ...
  @override
  _i4.Future<List<_i8.ChatConversation>> getConversations() =>
      (super.noSuchMethod(
        Invocation.method(
          #getConversations,
          [],
        ),
        returnValue: _i4.Future<List<_i8.ChatConversation>>.value(
            <_i8.ChatConversation>[]),
      ) as _i4.Future<List<_i8.ChatConversation>>);

  @override
  _i4.Future<_i8.ChatConversation?> getConversation(String? conversationId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getConversation,
          [conversationId],
        ),
        returnValue: _i4.Future<_i8.ChatConversation?>.value(),
      ) as _i4.Future<_i8.ChatConversation?>);

  @override
  _i4.Future<List<_i8.ChatConversation>> getUserConversations(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> forceRecreateDatabase() => (super.noSuchMethod(
        Invocation.method(
...
/// A class which mocks [UnifiedMessageService].
///
/// See the documentation for Mockito's code generation for more information.
class MockUnifiedMessageService extends _i1.Mock
    implements _i2.UnifiedMessageService {
  MockUnifiedMessageService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<_i2.MessageSendResult> sendMessage({
    required String? messageId,
    required String? recipientId,
    required String? body,
    String? conversationId,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i4.Future<_i2.MessageSendResult>.value(_FakeMessageSendResult_0(
          this,
          Invocation.method(
            #sendMessage,
            [],
      ...
      ) as _i4.Future<_i2.MessageSendResult>);

  @override
  _i9.MessageStatus? getMessageStatus(String? messageId) =>
      (super.noSuchMethod(Invocation.method(
        #getMessageStatus,
        [messageId],
      )) as _i9.MessageStatus?);
  ...
  @override
  _i4.Future<void> handleIncomingMessage({
    required String? messageId,
  ...
  @override
  void cleanupMessageState(String? messageId) => super.noSuchMethod(
        Invocation.method(
          #cleanupMessageState,
          [messageId],
        ),
